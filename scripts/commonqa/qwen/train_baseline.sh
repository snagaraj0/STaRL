...
python train_commonqa_baseline.py --num_epochs 5 --batch_size 5 --model_name Qwen/Qwen2.5-1.5B-Instruct --out_dir results/exp2_commonqa_qwen_baseline --reward_type binary